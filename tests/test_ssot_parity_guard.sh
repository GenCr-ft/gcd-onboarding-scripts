...
# --- Cycle 2a: unset URL (default) → guard does not fire (exits 0 with [WARN] locally / unauthenticated fetch in CI) ---
...
# --- Cycle 2b: valid https override → guard passes, exits 0 (unauthenticated fetch in CI / [WARN] locally) ---
